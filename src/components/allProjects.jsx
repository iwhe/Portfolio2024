...
const AllProjects = () => {
  ...
  return (
    <div className="allProjects  md:p-4 bg-[#030122] w-screen h-screen overflow-x-hidden box-border">
      ...
      <div className="content p-2 sm:p-4 lg:px-[100px] h-full">
            ...
            <div className="flex flex-col justify-start items-start w-full h-full gap-4 text-[20px]">
              {projects.map((project) => (
                <div
                  ...
                  className="project lg:h-36 md:h-32 sm:h-24 h-20 flex flex-row gap-2 box-border cursor-pointer hover:bg-white/10 rounded-xl p-2"
                  key={project.id}
                >
                  {/* Image Section */}
                  <div className="projectImage h-full rounded-2xl flex items-center justify-center aspect-video border border-blue-500 overflow-hidden hover:z-[10] transition-0.5s">
                    <img
                  ...
                  <div className="projectContent flex-1 box-border flex flex-col justify-between md:gap-2">
                    <div className="flex flex-col sm:gap-2">
                      ...
                      <div className="projectDescription relative text-[0.75rem] overflow-hidden text-white box-border">
                        <p className=" box-border whitespace-normal text-ellipsis line-clamp-1 md:line-clamp-2 text-sm">
                          <ReactMarkdown
                            ...
                            components={{
                              ...
                              h1: ({ node, ...props }) => (
                                <h1 className="text-base" {...props} />
                              ),
                              h2: ({ node, ...props }) => (
                                <h2 className="text-sm" {...props} />
                              ),
                              h3: ({ node, ...props }) => (
